...
Route::get('/registration', [PagesController::class, 'signup'])->name('signup');
Route::get('/login', [PagesController::class, 'signin'])->name('signin');
...
Route::Post('/contactus', [PagesController::class, 'contactsubmit'])->name('contact.submit');